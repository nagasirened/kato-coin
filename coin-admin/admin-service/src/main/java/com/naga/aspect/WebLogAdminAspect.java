...
public class WebLogAdminAspect {
    ...
    /**
     * 雪花算法 workerId  机器ID， dataCenterId 应用的ID
     */
     ...
     * 1 定义切入点
     */
    @Pointcut("execution(* com.naga.controller.*.*(..))") // controller 包里面所有类，类里面的所有方法 都有该切面
    public void webLog(){}
    ...
    public Object recodeWebLog(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        webLog.setSpendTime((int)(start - System.currentTimeMillis())/1000);
